        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
	                    ...
	                    <div class="row mb-3">
	                    	...
	                    	<div class="col-1">
	                    		<select class="form-control" id="shOption" name="shOption">
			                        ...
			                        <option value="2" <c:if test="${vo.shOption eq 2}">selected</c:if>>주소</option>
			                        <option value="3" <c:if test="${vo.shOption eq 3}">selected</c:if>>상세주소</option>
			                        <option value="4" <c:if test="${vo.shOption eq 4}">selected</c:if>>우편번호</option>
			                    </select>
	                    	</div>
	                    	<div class="col">
								...
								<c:otherwise>
									<c:forEach items="${list}" var="list" varStatus="status">
			                          <tr>
			                            ...
			                            <td><a href="javascript:goView(<c:out value="${list.maSeq }"/>)"> <c:out value="${list.nm }"/> </a></td>
	      	...
	      	var seq = $("input:hidden[name=maSeq]");
