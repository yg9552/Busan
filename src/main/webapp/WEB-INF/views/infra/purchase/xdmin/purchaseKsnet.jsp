...
<link href="../../../../../resources/assets/css/pgstyle.css" rel="stylesheet" type="text/css" charset="utf-8">
</head>
...
<table width="560" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="50" align="right" background="../../../../../resources/image/bg_top.gif" class="txt_pd1">KSNET WebHost Sample V1.4[JSP]</td>
  </tr>
  <tr>
    <td height="530" valign="top" background="../../../../../resources/image/bg_man.gif">	
	<table width="560" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="25">&nbsp;</td>
...
<table border='0' cellpadding='0' cellspacing='0' width='500' align='center'>
    ...
    <tr>
      <td align="center"><table width="400" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="110"><img src="../../../../../resources/image/ico_right.gif" width="11" height="11" align="absmiddle"> 결제수단</td> <!--신용카드/가상계좌/계좌이체/월드패스카드/포인트/휴대폰결제/상품권-->
          <td width="290">
        ...
        <tr>
          <td width="110"><img src="../../../../../resources/image/ico_right.gif" width="11" height="11" align="absmiddle"> 상점아이디</td> 
        ...
        <tr>
          <td width="110"><img src="../../../../../resources/image/ico_right.gif" width="11" height="11" align="absmiddle"> 주문번호</td> 
    ...
    <tr>
      <td align="center"><table width="400" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td width="110"><img src="../../../../../resources/image/ico_right.gif" width="11" height="11" align="absmiddle"> 주문자명</td> 
...
<!--------------------------------------------------------------------------------------------------------------------------->
  ...
  <tr>
    <td height="37" background="../../../../../resources/image/bg_bot.gif">&nbsp;</td>
  </tr>
</table>
</body>
</html>
