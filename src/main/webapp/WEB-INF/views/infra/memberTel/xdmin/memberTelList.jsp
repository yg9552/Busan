        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
								...
								<c:otherwise>
									<c:forEach items="${list}" var="list" varStatus="status">
			                          <tr>
			                            ...
			                            <td><a href="javascript:goView(<c:out value="${list.mtSeq }"/>)"> <c:out value="${list.nm }"/> </a></td>
	      	...
	      	var seq = $("input:hidden[name=mtSeq]");
